...
export default function ComponentCrudTramites(){
    ...
    const message_inputs = (input,name) => {
        return <span style={(input?.type !== "required" && input?.type !== "maxLength" && input?.type !== "min" && input?.type !== "pattern")? {} : { color : "red" }}>
            {
                (input?.type === "required")? (name === "Dias")? "Los dias son requeridos" : "El "+name.toLowerCase()+" es requerido" :
                ...
                (input?.type === "maxLength")? "El "+name.toLowerCase()+" debe tener menos de 10 caracteres" : name
            }
        </span>
    }
    ...
    return (
        <section className="container pt-3 pb-5">
            <section className="text-center">
                {
                    (isMobile)? 
                        <h4 className="text-primary font-weight-bold">FORMULARIO TRAMITES</h4> 
                    : 
                        <h1 className="text-primary font-weight-bold">FORMULARIO TRAMITES</h1>
                }
            </section>
            <section className="row py-3 d-flex">
                <article className={(isTablet)? "col-12 order-2 mt-3" : "col-10" }>
                    <form method="POST" action="" ref={ref_form} onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-group mb-3">
                            <label htmlFor="input-description">Descripcion</label>
                            <textarea className="form-control shadow-none border-primary" id="input-description" placeholder="Arrastrar y soltar..."></textarea>
                        </div>
                        ...
                        {
                            send_datos &&
                                <div className="mt-5 bg-success py-2 text-light d-flex justify-content-center align-items-center"> 
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-check-circle" viewBox="0 0 16 16">
                                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                                    </svg>
                ...
                <article className="text-center col">
                    <h5>Herramientas</h5>
                    <div className="row">
                        <div className={(isMobile)? "col-3 mb-3" : "col-sm-6 mb-4"}>
                            <div className="card btn p-0">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-body-text" viewBox="0 0 16 16">
                        ...
                        <div className={(isMobile)? "col-3 mb-3" : "col-sm-6 mb-4"}>
                            <div className="card btn p-0">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-123" viewBox="0 0 16 16">
                        ...
                        <div className={(isMobile)? "col-3 mb-3" : "col-sm-6 mb-3"}>
                            <div className="card btn p-0">
                                <div>
